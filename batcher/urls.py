...
urlpatterns = patterns('',
                       ...
                       url(r'^executions/(?P<yyyy_mm_dd>\d{4}-\d{2}-\d{2})/$', 'batch_apps.views.specific_date', name='daily_date'),
                       url(r'^executions/$', 'batch_apps.views.specific_date', name='daily_default'),
                       )
